...
from apps.kb.api.dependencies import get_graphrag_engine
from apps.kb.query.graphrag_engine import GraphRAGEngine, QueryIntent
...
def _build_next_steps(intent: QueryIntent, booking_links: list[dict], tenant_id: str | None = None) -> list[str]:
    ...
    from apps.kb.config import get_tenant_config, get_tenant_config_from_db
